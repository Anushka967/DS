...
public abstract class CalculatorPOA extends org.omg.PortableServer.Servant
 implements calcModule.CalculatorOperations, org.omg.CORBA.portable.InvokeHandler
{
                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    {
       case 0:  // calcModule/Calculator/add
       {
       ...
       case 1:  // calcModule/Calculator/sub
       {
         double a = in.read_double ();
         double b = in.read_double ();
         double $result = (double)0;
       ...
       case 2:  // calcModule/Calculator/mul
       {
         double a = in.read_double ();
         double b = in.read_double ();
         double $result = (double)0;
       ...
       case 3:  // calcModule/Calculator/div
       {
         double a = in.read_double ();
         double b = in.read_double ();
         double $result = (double)0;
